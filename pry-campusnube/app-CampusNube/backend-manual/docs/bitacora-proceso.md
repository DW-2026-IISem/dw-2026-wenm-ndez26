...
![](images/clipboard-4150084586.png)
...
![](images/clipboard-72411802.png)

**Sugerencia de commit (issue):**

``` bash
git add . 
git commit -m "feat: add dto update-teacher.dto.ts"
```

![](images/clipboard-4253550292.png)

#### 12.11— teacher.mapper.ts

![](images/clipboard-2587615631.png)
...
``` bash
git add .   
git commit --allow-empty -m "feat: wire progress into business module"
```
...
``` bash
git add .     
git commit -m "feat: add certificate not found exception"
```

![](images/clipboard-544686293.png)

#### 17.4 — certificates-repository.inteface.ts

Excepción de dominio. El caso de uso la lanza; el filter HTTP la traduce a status code.

![](images/clipboard-771284673.png)
...
``` bash
git add .    
git commit -m "feat: add use case get-certificate.use-case.ts"
```

![](images/clipboard-773564013.png)

#### 17.15 — list.certificates.use-case.ts

![](images/clipboard-1271198794.png)
...
![](images/clipboard-3631324120.png)
...
![](images/clipboard-3870842750.png)
...
![](images/clipboard-1133668855.png)
...
![](images/clipboard-2906240073.png)
